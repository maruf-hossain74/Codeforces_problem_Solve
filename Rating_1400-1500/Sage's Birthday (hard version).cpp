/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  $   Institute: JKKNIU                         $
      Problem: C_Sage_s_Birthday_easy_version                
  $   Date: 2024/12/23                          $
  $   Time: 23:35:09                            $
  $                                             $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/
...
int32_t main() {
    ...
    while(t--) {
        ...
        vector<int > soln;
        for(int i = 0; i < n; i++) {
            if(i % 2) soln.push_back(v[x++]);
            else soln.push_back(v[y++]);
        }
        int ans = 0;
        for(int i = 1; i < n-1; i++) {
            if(soln[i-1] > soln[i] && soln[i] < soln[i+1]) ans++;
        }
        cout << ans << endl;
        for(auto &it: soln) cout << it << " "; cout << endl;
    }
    return 0;
}
