...
//কোড না করতে করতে সিমপল বিষয়ও ভুল করতাছি!!!!!!! মাত্র কয়দিন ই তো হইল।
//এই কয়দিনে ৯০০ রেটিংও ইফ এলসে আটকে যাচ্ছি !!!! বাহ, বাহ, বাহ.........
//এখন আর মাথা আগের মত কাজ করে না।
...
int32_t main() {
    ...
    while(t--) {
        ...
        sort(A, A+n);
        if(n == 1) cout << 1 << endl;
        else if(A[0] == A[1]) cout << "Still Rozdil" << endl;
        else cout << ans << endl;
        //কোড না করতে করতে সিমপল বিষয়ও ভুল করতাছি!!!!!!! মাত্র কয়দিন ই তো হইল।
        //এই কয়দিনে ৯০০ রেটিংও ইফ এলসে আটকে যাচ্ছি !!!! বাহ, বাহ, বাহ.........
        //এখন আর মাথা আগের মত কাজ করে না।
