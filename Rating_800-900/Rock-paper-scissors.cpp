...
int32_t main() {
    ...
    while(t--) {
        ...
        if(a == 1 && c == 2) {
            ...
            else if(A[1] == "rock") cout << "M" << endl;
            else if(A[2] == "rock") cout << "S" << endl;
        }
        else if(b == 2 && c == 1) {
            if(A[0] == "scissors") cout << "F" << endl;
            else if(A[1] == "scissors") cout << "M" << endl;
            else if(A[2] == "scissors") cout << "S" << endl;
        }
        else if(b == 1 && a == 2) {
            if(A[0] == "paper") cout << "F" << endl;
            else if(A[1] == "paper") cout << "M" << endl;
            else if(A[2] == "paper") cout << "S" << endl;
        }
        else cout << "?" << endl;
    }
	return 0;
