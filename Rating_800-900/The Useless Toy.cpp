...
int32_t main() {
    ...
    while(t--) {
        ...
        int n; cin>> n;
        n %= 4;
        if(n == 0) cout << "undefined" << endl;
        else if(n == 1) {
            if(a == '^' && b == '>') cout << "cw" << endl;
            else if(a == '>' && b == 'v') cout << "cw" << endl;
            else if(a == 'v' && b == '<') cout << "cw" << endl;
            else if(a == '<' && b == '^') cout << "cw" << endl;
            else if(a == '^' && b == '<') cout << "ccw" << endl;
            else if(a == '>' && b == '^') cout << "ccw" << endl;
            else if(a == 'v' && b == '>') cout << "ccw" << endl;
            else if(a == '<' && b == 'v') cout << "ccw" << endl;
            else cout << "undefined" << endl;
        }
        else if(n == 2) cout << "undefined" << endl;
        else if(n == 3) {
            if(a == '^' && b == '>') cout << "ccw" << endl;
            else if(a == '>' && b == 'v') cout << "ccw" << endl;
            else if(a == 'v' && b == '<') cout << "ccw" << endl;
            else if(a == '<' && b == '^') cout << "ccw" << endl;
            else if(a == '^' && b == '<') cout << "cw" << endl;
