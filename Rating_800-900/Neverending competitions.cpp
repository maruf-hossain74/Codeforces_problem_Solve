/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  $   Institute: JKKNIU                         $
      Problem: X_Neverending_competitions                
  $   Date: 2024/10/09                          $
  $   Time: 21:49:44                            $
  $                                             $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/
...
int32_t main() {
    ...
    while(t--) {
        ...
        for(int i = 0; i < n; i++) {
            string k; cin>> k;
            string fs = k.substr(0,3);
            string en = k.substr(5,3);
            vp.push_back({{fs, en}, 0});
        }
        for(int i = 0; i < n; i++) {
            for(auto &it: vp) {
                if(it.first.first == des && it.second == 0) {
                    des = it.first.second;
                    it.second = 1;
                }
            }
        }
        if(des == s) cout << "home" << endl;
