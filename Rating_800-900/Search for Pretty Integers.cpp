/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  $   Institute: JKKNIU                         $
      Problem: AL_Search_for_Pretty_Integers                
  $   Date: 2024/10/10                          $
  $   Time: 03:13:50                            $
  $                                             $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/
...
int32_t main() {
    ...
    while(t--) {
        ...
        map<int, int> mp1, mp2;
        int mn1 = 10, mn2 = 10;
        for(int i = 0; i < n; i++) { int x; cin>> x; mn1 = min({mn1, x}); mp1[x]++;}
        for(int i = 0; i < m; i++) { int x; cin>> x; mn2 = min({mn2, x}); mp2[x]++;}
        bool ans = false;
        for(int i = 1; i < 10; i++) {
            if(mp1[i] > 0 && mp2[i] > 0) {
                cout << i << endl;
        ...
        if(!ans) cout << min({mn1, mn2})  << max({mn1, mn2}) << endl;
    }
    return 0;
}
