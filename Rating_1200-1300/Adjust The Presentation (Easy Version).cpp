/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  $   Institute: JKKNIU                         $
      Problem: B_Adjust_The_Presentation_Easy_Version                
  $   Date: 2025/03/05                          $
  $   Time: 23:31:03                            $
  $                                             $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/
...
int32_t main() {
    ...
    while(t--) {
        ...
        for(auto &it: B) {
            if(A.empty()) break;
            if(st.empty()) {
                if(A.back() == it) st.insert(it), A.pop_back();
                else { ans = false; break;}
            }
            else {
                if(it == A.back()) st.insert(it), A.pop_back();
                else if(st.find(it) != st.end()) continue;
                else {
                    ans = false;
                    break;
                }
