...
int32_t main() {
    ...
    while(t--) {
        ...
        string s; cin>> s;
        int si = 0, tw = 0, sum = 0;
        for(auto &it: s) it == '2'? tw++: it == '3'? si++ : 0, sum += it-'0';
        int need = (9-sum%9)%9, demo = si*6+tw*2;
        if(need == 0) yes;
        else if(need == 1 && demo>9 && tw > 1) yes;
        else if(need == 2 && tw) yes;
        else if(need == 3 && demo>11) yes;
        else if(need == 4 && tw>1) yes;
        else if(need == 5 && tw && demo>13) yes;
        else if(need == 6 && demo > 5) yes;
        else if(need == 7 && tw > 1 && demo > 15) yes;
        else if(need == 8 && tw && demo> 7) yes;
        else no;
    }
    return 0;
}
