...
int32_t main() {
    ...
    while(t--) {
        ...
        // int ans = 0;
        // for(int i = 1; i <= n; i+=2) {
        //     if(v[i-1] == x[i-1] && v[i] != x[i]) {
        //         ans++;
        //         v[i] = x[i];
        //     }
        //     else if(v[i-1] == v[i] && x[i-1] != x[i]) {
        //         ans++;
        //         x[i-1] = x[i];
        //     }
        //     else if(x[i-1] == x[i] && v[i-1] != v[i]) {
        //         ans++;
        //         v[i] = v[i-1];
        //     }
        //     else if(v[i] == x[i] && v[i-1] != x[i-1]) {
        //         ans++;
        //         v[i-1] = x[i-1];
        //     }
        //     else if((v[i] != x[i]) && x[i-1] != x[i] && v[i-1] != v[i] && v[i-1] != x[i-1]) {
        //         ans++;
        //         i--;
        //     }
        // }
        ...
        //     m2.push_back(x);
        // }
        // // for(auto &it: m1) cout << it; cout << endl;
        // // for(auto &it: m2) cout << it; cout << endl;
        // for(int i = 0; i < n; i++) {
        //     if(m1[i] == m2[i]) st1.erase(i), st2.erase(i);
        // }
        // vector<int> v1, v2;
        // for(auto &it: st1) v1.push_back(it), v2.push_back(it);
        // for(int i = 1; i < v1.size(); i++) {
        //     if(v1[i-1]+1 == v1[i] && m1[v1[i-1]] == m1[v1[i]]) {
        //         st1.erase(v1[i-1]);
        //         st1.erase(v1[i]);
        //     }
        // }
        ...
        //     if(v2[i-1]+1 == v2[i] && m2[v2[i-1]] == m2[v2[i]]) {
        //         st2.erase(v2[i-1]);
        //         st2.erase(v2[i]);
        //         i++;
        //     }
