/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  $   Institute: JKKNIU                         $
      Problem: A_Shortest_path_of_the_king                
  $   Date: 2025/02/28                          $
  $   Time: 22:41:00                            $
  $                                             $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/
...
int32_t main() {
    ...
    while(t--) {
        //cout << "Case " << ++cs << ": ";
        char a, b;
        int y1, y2; cin>> a>> y1>> b>> y2;
        int x1 = a - 'a' + 1;
        int x2 = b - 'a' + 1;
        int ans = max({abs(x1-x2), abs(y1-y2)});
        cout << ans << endl;
        for(int i = 0; i < ans; i++) {
            if(x1 < x2 && y1 > y2) {x1++, y1--;cout << "RD" << endl;}
            else if(x1 > x2 && y1 < y2) {x1--, y1++;cout << "LU" << endl;}
            else if(x1 < x2 && y1 < y2) {x1++, y1++;cout << "RU" << endl;}
            else if(x1 > x2 && y1 > y2) {x1--, y1--;cout << "LD" << endl;}
            else if(y1 > y2) {y1--;cout << "D" << endl;}
            else if(y1 < y2) {y1--;cout << "U" << endl;}
            else if(x1 > x2) {x1--;cout << "L" << endl;}
            else if(x1 < x2) {x1--;cout << "R" << endl;}
        }
    }
    return 0;
}
