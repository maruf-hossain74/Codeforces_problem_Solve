/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  $   Institute: JKKNIU                         $
      Problem: D_Scenes_From_a_Memory                
  $   Date: 2024/12/29                          $
  $   Time: 23:44:16                            $
  $                                             $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/
...
int32_t main() {
    ...
    while(t--) {
        ...
        if(st.find('1') != st.end()) cout << 1 << endl << 1 << endl;
        else if(st.find('4') != st.end()) cout << 1 << endl << 4 << endl;
        else if(st.find('6') != st.end()) cout << 1 << endl << 6 << endl;
        else if(st.find('8') != st.end()) cout << 1 << endl << 8 << endl;
        else if(st.find('9') != st.end()) cout << 1 << endl << 9 << endl;
        else {
            bool ans = false;
