...
int32_t main() {
    ...
    while(t--) {
        //cout << "Case " << ++cs << ": ";
        int x, y, a, b, d; cin>> x>> y>> a>> b>> d;
        if(a-d <= 1 && b-d <= 1) cout << -1 << endl;
        else if(a+d >= x && b+d >= y) cout << -1 << endl;
        else if(a+d >= x && a-d <= 1) cout << -1 << endl;
        else if(b+d >= y && b-d <= 1) cout << -1 << endl;
